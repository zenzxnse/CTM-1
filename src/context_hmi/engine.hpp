...
/** Interpret only the supported rule vocabulary; ambiguity returns a clarification object. */
...
/** Produce synthetic values for a logical tick. This does not read or control equipment. */
